// The code is forked from https://codebender.cc/sketch:41433 author: https://codebender.cc/user/gweezer
// Modified only to display the date and time on MicroView
// Stored on https://codebender.cc/sketch:47544 author https://codebender.cc/user/suk.pavel
// 
// DS1302 RTC
// ----------
//
...
// #define SET_DATE_TIME_JUST_ONCE
  ...
  dayofmonth = 5; // Day of month, 1...31
  month      = 9;  // month 1...12
  year       = 2014;
